                    ...
                    >
                        ...
                        <form class="mt-5" method="post" action="{{ route('addRole') }}">
                            ...
                            <div>
                                ...
                                <input required placeholder="{{ trans('admin-roles.new-role-name') }}" type="text" name="role_name"
                            ...
                            <div class="mt-4">
                                ...
                                <input placeholder="{{ trans('admin-roles.new-role-description-placeholder') }}" type="text"
