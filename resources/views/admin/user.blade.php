                    ...
                    <div class="user_input sticky top-0 p-4 w-full hidden">
                        <div class="text-gray-700">
                            <div class="grid md:grid-cols-2 text-sm">
                                ...
                                <div class="grid grid-cols-2">
                                    <div
                                        class="px-4 py-2 font-semibold m-2">{{ trans('view-profilepage-profile.login') }}</div>
                                ...
                                <div class="grid grid-cols-2">
                                    <div
                                        class="px-4 py-2 font-semibold m-2">{{ trans('view-profilepage-profile.sex') }}</div>
                                    <div class="flex-row">
                                        <div class="flex items-center mb-3 last:mb-0">
                                            ...
                                            <label class="ml-2 text-sm"
                                                   for="male">{{ trans('base-phrases.sex-male') }}</label>
                                        </div>
                                        <div class="flex items-center mb-3 last:mb-0">
                                            @if($user->sex == 'female')
                                                <input
                                            ...
                                            @endif
                                            <label class="ml-2 text-sm"
                                                   for="female">{{ trans('base-phrases.sex-female') }}</label>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="grid grid-cols-2 m-2">
                                    <div
                                        class="px-4 py-2 font-semibold">{{ trans('view-profilepage-profile.phone') }}</div>
                                ...
                                <div class="grid grid-cols-2 m-2">
                                    <div
                                        class="px-4 py-2 font-semibold">{{ trans('view-profilepage-profile.email') }}</div>
