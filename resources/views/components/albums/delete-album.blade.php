                        ...
                        <div class="sm:flex sm:items-start">
                            ...
                            <div class="mt-3 text-center sm:mt-0 sm:ml-4 sm:text-left">
                                <h3 class="text-lg leading-6 font-medium text-gray-900"
                                    id="modal-title">
                                    {{ trans('delete-album-form.title') }}
                                </h3>
                                <div class="mt-2">
                                    <p class="text-sm text-gray-500">
                                        {{ trans('delete-album-form.message', ['period' => config('filesystems.lifetime')]) }}
                                    </p>
                                </div>
                            </div>
                        </div>
                        ...
                        @if($album->photos->count() != 0)
                            <label for="delete_photos_checkbox" class="inline-flex items-center">
                                <input type="checkbox"
                                       ...
                                       name="remember">
                                <span class="ml-2 text-sm text-gray-600">{{ trans('delete-album-form.checkbox') }}</span>
                            </label>
                        @endif
                    </div>
                </div>
